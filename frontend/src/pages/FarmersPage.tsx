  ...
  return (
    <div className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.map((farmer) => (
                  <tr key={farmer.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                    ...
                    <td className="p-4 text-right font-medium">{formatCurrency(farmer.outstandingBalance)}</td>
                    <td className="p-4 text-right">
                      <div className="flex justify-end gap-2">
                        <Link to={`/farmers/${farmer.id}`} className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 hover:text-primary transition-colors">
                          <Eye className="h-4 w-4" />
                        </Link>
                        <button onClick={() => openEdit(farmer)} className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 hover:text-primary transition-colors">
                          <Pencil className="h-4 w-4" />
                        </button>
                        <button onClick={() => setDeleteId(farmer.id)} className="p-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 text-gray-500 hover:text-red-500 transition-colors">
      ...
      <ConfirmDialog
        ...
        title="Delete Farmer"
        message="Are you sure you want to delete this farmer? This is a soft delete and can be recovered from records."
      />
    </div>
  )
}
