...
async function main() {
  await runWithWorkspace('demo', async () => {
    ...
    try {
      ...
      assert(html.includes('Qty of') && html.includes('one bag'), 'farmer bill missing Qty of one bag column')
      ...
      assert(html.includes('Extra') && html.includes('KG'), 'farmer bill missing Extra KG column beside man')
      ...
      assert(html.includes('class="name"'), 'farmer bill missing product name column')
      ...
      assert(buyerHtml.includes('Qty of') && buyerHtml.includes('one bag'), 'buyer bill missing Qty of one bag column')
