...
async function main() {
  await runWithWorkspace('demo', async () => {
    ...
    try {
      ...
      assert(html.includes('Qty of one bag'), 'farmer bill missing Qty of one bag heading')
      ...
      assert(html.includes('Extra KG'), 'farmer bill missing Extra KG heading')
      ...
      assert(html.includes('class="product-name"'), 'farmer bill missing product next to address')
      assert(html.includes(product.name), 'farmer bill missing full product name')
      ...
      assert(buyerHtml.includes('Qty of one bag'), 'buyer bill missing Qty of one bag heading')
      assert(buyerHtml.includes('class="product-name"'), 'buyer bill missing product next to address')
