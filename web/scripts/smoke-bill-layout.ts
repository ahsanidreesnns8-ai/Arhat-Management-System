...
async function main() {
  await runWithWorkspace('demo', async () => {
    ...
    try {
      ...
      assert(html.includes('>Q<') || html.includes('>Q</th>'), 'farmer bill missing Q heading')
      assert(html.includes('>Bags<') || html.includes('<th>Bags</th>') || html.includes('>Bags</th>'), 'farmer bill missing Bags column')
      assert(html.includes('>Ext<') || html.includes('>Ext</th>'), 'farmer bill missing Ext heading')
      ...
      assert(buyerHtml.includes('>Q<') || buyerHtml.includes('>Q</th>'), 'buyer bill missing Q heading')
