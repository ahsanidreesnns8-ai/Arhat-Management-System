...
const CROP_UI: Record<GrainCrop, {
  ...
  wheat: {
    ...
    description: 'Create your own Wheat Khata ID with a name and secret code, like Paddy Khata. Cash in each ID also updates Arhat Amount.',
  ...
  barley: {
    ...
    description: 'Create your own Barley Khata ID with a name and secret code, like Paddy Khata. Cash in each ID also updates Arhat Amount.',
  ...
  maize: {
    ...
    description: 'Create your own Maize Khata ID with a name and secret code, like Paddy Khata. Cash in each ID also updates Arhat Amount.',
  ...
  other: {
    ...
    description: 'Create a named khata with a secret code when you need another book. Cash in each ID also updates Arhat Amount.',
