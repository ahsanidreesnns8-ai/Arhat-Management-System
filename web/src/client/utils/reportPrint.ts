...
<head>
  ...
  <style>
    ...
    .brand{text-align:center;border-bottom:3px solid #1F4D32;padding-bottom:16px;margin-bottom:20px}
    .brand img{max-height:88px;display:block;margin:0 auto 10px}
    .brand h1{margin:0;color:#1F4D32;font-size:24px}
    ...
    .metric .value{font-size:18px;font-weight:700;margin-top:4px;color:#1F4D32}
    table{width:100%;border-collapse:collapse;margin-top:10px;font-size:13px}
    th,td{border:1px solid #cbd5e1;padding:8px 10px;text-align:${urdu ? 'right' : 'left'}}
    th{background:#1F4D32;color:#fff}
    .empty{color:#64748b;margin-top:16px}
    .footer{margin-top:28px;padding-top:12px;border-top:2px solid #C5A059;text-align:center;color:#1F4D32;font-weight:700}
    .creator-credit{margin-top:10px;text-align:center;color:#1F4D32}
