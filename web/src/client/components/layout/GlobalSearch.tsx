...
const MODULE_SHORTCUTS: {
  ...
  { id: 'wheat-khata', to: '/wheat-khata', labelKey: 'wheatKhata', keywords: ['wheat khata', 'wheat', 'گندم', 'کھاتہ'] },
  { id: 'barley-khata', to: '/barley-khata', labelKey: 'barleyKhata', keywords: ['barley khata', 'barley', 'جو', 'کھاتہ'] },
  { id: 'maize-khata', to: '/maize-khata', labelKey: 'maizeKhata', keywords: ['maize khata', 'maize', 'corn', 'مکئی', 'کھاتہ'] },
  { id: 'others-khata', to: '/others-khata', labelKey: 'othersKhata', keywords: ['others khata', 'other khata', 'create khata', 'دیگر کھاتہ', 'کھاتہ'] },
