...
const ROUTES: { path: string; label: string; keys: string[] }[] = [
  ...
  { path: '/wheat-khata', label: 'Wheat Khata', keys: ['wheat khata', 'wheat', 'گندم کھاتہ', 'گندم'] },
  { path: '/barley-khata', label: 'Barley Khata', keys: ['barley khata', 'barley', 'جو کھاتہ', 'جو'] },
  { path: '/maize-khata', label: 'Maize Khata', keys: ['maize khata', 'maize', 'corn khata', 'مکئی کھاتہ', 'مکئی'] },
  { path: '/others-khata', label: 'Others Khata', keys: ['others khata', 'other khata', 'دیگر کھاتہ'] },
  { path: '/paddy-khata', label: 'Paddy Khata', keys: ['paddy khata', 'paddy', 'dhan', 'rice khata', 'دھان کھاتہ', 'دھان'] },
  { path: '/arhat-amount', label: 'Arhat Amount', keys: ['arhat amount', 'merge all amount', 'آرھٹ رقم'] },
  { path: '/arhat-head', label: 'Arhat Head', keys: ['arhat head', 'آرھٹ ہیڈ'] },
  { path: '/paledari-head', label: 'Paledari Head', keys: ['paledari head', 'پیلیداری'] },
  { path: '/tolai-head', label: 'Tolai Head', keys: ['tolai head', 'تلائی'] },
