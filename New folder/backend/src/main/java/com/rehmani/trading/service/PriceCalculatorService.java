...
public class PriceCalculatorService {
    ...
    public PriceCalculationResult calculate(PriceCalculationRequest request) {
        ...
        BigDecimal totalWeight = weightPerBag.multiply(BigDecimal.valueOf(bags)).setScale(2, RoundingMode.HALF_UP);
        ...
        BigDecimal arhatPct = settings.getArhatSharePercentage();
        BigDecimal munshiPct = settings.getSupervisorSharePercentage();
        BigDecimal workersPct = settings.getLaborSharePercentage();
