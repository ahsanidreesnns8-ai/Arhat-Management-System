...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Welcome to Rehmani Trading Company')
      navigate('/')
    } catch {
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h1 className="text-3xl font-bold">Rehmani Trading Company</h1>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50 dark:bg-surface-dark">
        ...
        >
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 dark:text-white">Rehmani Trading Company</h1>
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            &copy; {new Date().getFullYear()} Rehmani Trading Company
          </p>
        </motion.div>
      </div>
    </div>
